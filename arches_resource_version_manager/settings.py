"""
Django settings for arches_resource_version_manager project.
"""
...
APP_NAME = 'arches_resource_version_manager'
...
DATATYPE_LOCATIONS.append('arches_resource_version_manager.datatypes')
FUNCTION_LOCATIONS.append('arches_resource_version_manager.functions')
ETL_MODULE_LOCATIONS.append('arches_resource_version_manager.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_resource_version_manager.search_components')
...
SECRET_KEY = 'django-insecure-5&+d#l^&%3s_1519*3u^xdatezjii1^fkz92-2a2tis$q6*67b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_resource_version_manager.urls"
ROOT_HOSTCONF = "arches_resource_version_manager.hosts"

DEFAULT_HOST = "arches_resource_version_manager"
...
ELASTICSEARCH_PREFIX = 'arches_resource_version_manager'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_resource_version_manager.search_indexes.sample_index.SampleIndex',
...
DATABASES = {
    "default": {
        ...
        "HOST": "localhost",
        "NAME": "arches_resource_version_manager",
        "OPTIONS": {
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "arches_resource_version_manager",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'arches_resource_version_manager.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_resource_version_manager'
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_resource_version_manager.search.es_mapping_modifier.EsMappingModifier"]
