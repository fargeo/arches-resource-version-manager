...
module.exports = {
  input: {
    path: "./arches_resource_version_manager/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_resource_version_manager/locale", // output path of all created files
